...
{
    public sealed class FieldToFieldTransformationControl : Control
    {
        public static readonly DependencyProperty ConfigurationProperty =
            DependencyProperty.Register(nameof(Configuration), typeof(FieldToFieldTransformation),
                typeof(FieldToFieldTransformationControl), new PropertyMetadata(DependencyProperty.UnsetValue));
        ...
        {
            this.DefaultStyleKey = typeof(FieldToFieldTransformationControl);
